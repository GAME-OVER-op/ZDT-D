...
REQUIRED_EXTERNAL_BINS=(byedpi dnscrypt dpitunnel-cli nfqws nfqws2 opera-proxy sing-box hysteria2 wireproxy torproxy lyrebird tun2socks openvpn mihomo amneziawg-go awg mieru qwdtt-cli qwdtt-transport)
